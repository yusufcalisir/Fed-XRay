...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  EN: {
    ...
    kpi_rounds: "Rounds",
    kpi_samples: "Patients",
    kpi_status: "Status",
    kpi_status_ready: "Ready",
    kpi_status_trained: "Trained",
    kpi_status_training: "Training",
  ...
  TR: {
    ...
    kpi_rounds: "Turlar",
    kpi_samples: "Hastalar",
    kpi_status: "Durum",
    kpi_status_ready: "Hazır",
    kpi_status_trained: "Eğitildi",
    kpi_status_training: "Eğitiliyor",
